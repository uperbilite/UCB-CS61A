...
def count_coins(change):
    ...
    """
    "*** YOUR CODE HERE ***"
    def count_change(change, coin):
        if change == 0:
            return 1
        elif change < 0 or coin == None:
            return 0
        else:
            return count_change(change - coin, coin) + count_change(change, ascending_coin(coin))
    return count_change(change, 1)  # Or count_change(change, 25) with decending_coin()
