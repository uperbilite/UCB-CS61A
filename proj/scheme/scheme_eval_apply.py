...
def scheme_eval(expr, env, _=None):  # Optional third argument is ignored
    ...
    """
    # Evaluate atoms
    if scheme_symbolp(expr): # look up names in the current environment
        return env.lookup(expr)
    elif self_evaluating(expr): # return self-evaluating expressions 
        return expr
    ...
    if scheme_symbolp(first) and first in scheme_forms.SPECIAL_FORMS: # evaluate special forms
