...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        if symbol not in self.bindings and self.parent is not None:
    ...
    def make_child_frame(self, formals, vals):
        ...
        def check_error():
            if formals is nil and vals is not nil:
                raise SchemeError('unmatched formals and vals')
            if vals is nil and formals is not nil:
                raise SchemeError('unmatched formals and vals')
            return True
        
        child_frame = Frame(self)
        while formals is not nil and vals is not nil and check_error():
