...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        opponent.deck.cards = [card for card in copy if card.attack != opponent_card.attack and card.defense != opponent_card.defense]
        for card in player.deck.cards + opponent.deck.cards:
